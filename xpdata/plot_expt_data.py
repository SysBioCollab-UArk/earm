...
for reporter in reporters:
    ...
    plt.errorbar(data['Time'] / 3600, min_max_norm, yerr=yerr, fmt='o', ms=6,
                 capsize=4, label=labels[reporter])
...
params = np.genfromtxt(os.path.join('..', 'EARM_2_0_M1a_fitted_params.txt'), dtype=None, delimiter=',',
                                    encoding="utf_8_sig")
print(params)
